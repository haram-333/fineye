...
class InvoiceDetailsView extends GetView<InvoiceDetailsController> {
  ...
  Widget _buildInvoiceImage() {
    ...
    final hasLocalFile =
        kIsWeb
            ? controller.invoiceImageBytes != null
            : controller.invoiceImageFile != null;
                ...
                Row(
                  ...
                  children: [
                    ...
                    Flexible(
                      child: Obx(
                        () => Text(
                          'AED ${FormatHelper.amount(controller.grossAmount.value + controller.additionalCharges.value)}',
                          style: const TextStyle(
                            fontSize: 16,
                            fontWeight: FontWeight.bold,
                ...
                Row(
                  ...
                  children: [
                    Flexible(
                      ...
                      child: Obx(
                        () => Text(
                          '${'vat_amount'.tr} (5%): AED ${FormatHelper.amount(controller.vatAmount.value)}',
                          style: const TextStyle(
                            fontSize: 12,
                            color: Color(0xFF6B7280),
                          ),
                    ...
                    Flexible(
                      ...
                      child: Row(
                        ...
                        children: [
                          Flexible(
                            child: Text(
                              controller.invoice.supplierName,
                              style: const TextStyle(
                                fontSize: 12,
                                color: Color(0xFF6B7280),
                              ),
      ...
      return Container(
        ...
        child: Column(
          ...
          children: [
            ...
            const SizedBox(height: 4),
            Text(
              'invoice_risk_subtitle_with_count'.trParams({
                'count': risks.length.toString(),
              }),
                ...
                () => _buildTextField(
                  ...
                  value:
                      controller.invoiceDate.value != null
                          ? FormatHelper.date(controller.invoiceDate.value!)
                          : '',
                  isDate: true,
            ...
            children: [
              Expanded(
                child: _buildInvoiceTypeOption(
                  label: 'purchase_input_vat'.tr,
                  value: 'purchase',
                  isSelected:
                      controller.selectedInvoiceType.value == 'purchase',
                ),
              ),
              const SizedBox(width: 12),
              Expanded(
                child: _buildInvoiceTypeOption(
                  label: 'sales_output_vat'.tr,
                  value: 'sale',
                  isSelected: controller.selectedInvoiceType.value == 'sale',
                ),
              ),
            ],
          ),
  ...
  Widget _buildInvoiceTypeOption({
    ...
    return InkWell(
      onTap: () => controller.selectedInvoiceType.value = value,
      borderRadius: BorderRadius.circular(10),
      child: Container(
        ...
        decoration: BoxDecoration(
          ...
          border: Border.all(
            color:
                isSelected ? const Color(0xFF1E6FFF) : const Color(0xFFD1D5DB),
          ),
        ),
        child: Row(
          children: [
      ...
      children: [
        ...
        Obx(
          () => DropdownButtonFormField<String>(
            ...
            items:
                controller.currentCategories.map((String c) {
      ...
      children: [
        ...
        Row(
          children: [
            ...
            Expanded(
              child: _buildMoneyField(
                label: 'lbl_additional_charges'.tr,
          ...
          children: [
            ...
            Obx(() {
              final total =
                  ...
                  controller.additionalCharges.value;
              final displayText =
                  total > 0 ? FormatHelper.amount(total) : '0.00';
              return TextField(
  ...
  Widget _buildRadioOption(String label, bool value) {
    return GestureDetector(
      ...
      child: Row(
        children: [
          Icon(
            controller.isVatInclusive.value == value
      ...
      child: Column(
        ...
        children: [
          ...
          Obx(
            () => Row(
              children: [
                _buildPaymentRadioOption('lbl_paid'.tr, true),
                const SizedBox(width: 24),
                _buildPaymentRadioOption('lbl_not_paid'.tr, false),
              ],
            ),
          ),
          const SizedBox(height: 16),
                      ...
                      child: Row(
                        ...
                        children: [
                          Directionality(
                            ...
                            child: Text(
                              controller.dueDate.value != null
                                  ? FormatHelper.date(controller.dueDate.value!)
                                  : 'select_date'.tr,
                              style: TextStyle(
                                fontSize: 14,
                                color:
      ...
      child: Column(
        ...
        children: [
          ...
          Obx(
            () => _buildReviewRow(
              'short_net'.tr,
              'AED ${FormatHelper.amount(controller.netAmount.value)}',
            ),
          ),
          Obx(
            () => _buildReviewRow(
              'short_vat'.tr,
              'AED ${FormatHelper.amount(controller.vatAmount.value)}',
            ),
          ),
          Obx(
            () => _buildReviewRow(
              'lbl_additional_charges'.tr,
              'AED ${FormatHelper.amount(controller.additionalCharges.value)}',
            ),
          ),
          Obx(
            () => _buildReviewRow(
          ...
          Obx(
            () => _buildReviewRow(
              'ct_deductible_toggle'.tr,
              controller.isCtDeductible.value
                  ? 'ct_deductible'.tr
                  : 'ct_non_deductible'.tr,
              isBold: true,
            ),
          ),
          const SizedBox(height: 12),
          ...
          Expanded(
            child: Column(
              ...
              children: [
                ...
                Text(
                  'show_original_subtitle'
                      .tr, // "Tap to open full-screen preview"
                  style: const TextStyle(
                    fontSize: 12,
                    color: Color(0xFF6B7280),
                  ),
        ...
        children: [
          ...
          Expanded(
            child: Obx(
              () => ElevatedButton(
                onPressed:
                    (controller.isSaving.value || !controller.hasChanges.value)
                        ? null
                        : controller.confirmAndSave,
                style: ElevatedButton.styleFrom(
                  backgroundColor: const Color(0xFF1E6FFF), // Primary Blue
  ...
  Widget _buildMoneyField({
    ...
    if (readOnly) {
      return Column(
        ...
        children: [
          ...
          Obx(() {
            final displayText =
                value.value > 0 ? FormatHelper.amount(value.value) : '0.00';
    ...
    if (textController == null) {
      throw Exception(
        'TextEditingController must be provided for editable money fields',
      );
    }
      ...
      children: [
        ...
        Directionality(
          ...
          child: TextField(
            key: ValueKey(
              'money_$label',
            ), // Unique key to prevent rebuild issues
